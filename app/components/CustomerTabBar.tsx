// app/components/CustomerTabBar.tsx (rename from CustomTabBar.tsx)
...
export const CustomerTabBar = ({ state, descriptors, navigation }: any) => {
  ...
  const tabs = [
    { name: "index", label: "Home", icon: "restaurant" },
      ...
      {tabs.map((tab, index) => {
        ...
        return (
          ...
          >
            ...
            {tab.name === "orders" && user?.hasNewOrders && !user?.is_guest && (
...
export default CustomerTabBar; // Add this line
